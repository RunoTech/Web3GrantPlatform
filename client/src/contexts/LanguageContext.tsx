...
const translations = {
  en: {
    ...
    // Donation History
    'donations.history.title': 'Donation History',
    'donations.history.connect_wallet': 'Connect Your Wallet',
    'donations.history.connect_desc': 'Connect your wallet to view your donation history',
    'donations.history.filters': 'Filters',
    'donations.history.start_date': 'Start Date',
    'donations.history.end_date': 'End Date',
    'donations.history.min_amount': 'Min Amount (USDT)',
    'donations.history.campaign_type': 'Campaign Type',
    'donations.history.all_types': 'All Types',
    'donations.history.donations': 'Donations',
    'donations.history.business_funding': 'Business Funding',
    'donations.history.apply_filters': 'Apply Filters',
    'donations.history.clear_all': 'Clear All',
    'donations.history.campaign': 'Campaign',
    'donations.history.amount': 'Amount',
    'donations.history.type': 'Type',
    'donations.history.network': 'Network',
    'donations.history.date': 'Date',
    'donations.history.transaction': 'Transaction',
    'donations.history.no_donations': 'No Donations Found',
    'donations.history.try_adjusting': 'Try adjusting your filters',
    'donations.history.no_donations_yet': 'No donations made yet',
