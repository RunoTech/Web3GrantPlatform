        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4 items-center justify-center">
              <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-primary/10 to-success/10 px-6 py-3 rounded-full border border-primary/20">
                ...
                <span className="text-lg font-bold text-primary">{dailyTotalPrize > 0 ? `${dailyTotalPrize} USDT` : ''}</span>
              ...
              <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-accent/10 to-muted/10 px-4 py-2 rounded-full border border-accent/20">
                ...
                <span className="text-sm font-bold text-accent">{drawsPerDay > 0 ? `${drawsPerDay} DRAWS` : ''}</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <div className="card-standard p-6 relative overflow-hidden">
              ...
              <div className="relative z-10 text-center space-y-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-primary mb-1">{morningDrawTime ? `${morningDrawTime} DRAW` : ''}</h3>
                  <p className="text-3xl font-bold text-foreground">{morningDrawPrize > 0 ? `${morningDrawPrize} USDT` : ''}</p>
                  <p className="text-sm text-muted-foreground">{winnersPerDraw > 0 ? `${winnersPerDraw} winners • Morning draw` : 'Morning draw'}</p>
                </div>
              </div>
            </div>
            ...
            <div className="card-standard p-6 relative overflow-hidden">
              ...
              <div className="relative z-10 text-center space-y-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-accent mb-1">{afternoonDrawTime ? `${afternoonDrawTime} DRAW` : ''}</h3>
                  <p className="text-3xl font-bold text-foreground">{afternoonDrawPrize > 0 ? `${afternoonDrawPrize} USDT` : ''}</p>
                  <p className="text-sm text-muted-foreground">{winnersPerDraw > 0 ? `${winnersPerDraw} winners • Afternoon draw` : 'Afternoon draw'}</p>
                </div>
              </div>
            </div>
            ...
            <div className="card-standard p-6 relative overflow-hidden">
              ...
              <div className="relative z-10 text-center space-y-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-success mb-1">{eveningDrawTime ? `${eveningDrawTime} DRAW` : ''}</h3>
                  <p className="text-3xl font-bold text-foreground">{eveningDrawPrize > 0 ? `${eveningDrawPrize} USDT` : ''}</p>
                  <p className="text-sm text-muted-foreground">{winnersPerDraw > 0 ? `${winnersPerDraw} winners • Evening draw` : 'Evening draw'}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center p-6 card-standard">
              ...
              <div className="text-2xl font-bold text-primary mb-1">{dailyTotalPrize > 0 ? dailyTotalPrize : ''}</div>
            ...
            <div className="text-center p-6 card-standard">
              ...
              <div className="text-2xl font-bold text-accent mb-1">{totalDailyWinners > 0 ? totalDailyWinners : ''}</div>
            ...
            <div className="text-center p-6 card-standard">
              ...
              <div className="text-2xl font-bold text-success mb-1">{drawsPerDay > 0 ? drawsPerDay : ''}</div>
